...
Download the AdventureWorks sample database (or another SQL Server .bak file).
...
This repository is only the database setup layer.
...
Those materials can reference this repo as a standard, reusable SQL Server environment.